      ...
      <section id="tickets" className="px-6 pb-28">
        <div className="mx-auto max-w-lg">
          ...
          {/* <p className="mt-6 text-center font-mono text-xs text-bone-600">
            ...
            <p className="mt-6 text-center font-mono text-xs text-bone-600">
 For any queries please connect {"9303xxxxxx"}
  {/* <a
    href="https://wa.me/919303449838"
    target="_blank"
    rel="noopener noreferrer"
    className="inline-flex items-center gap-1.5 text-emerald-400 underline-offset-2 hover:underline"
  >
    <svg
    ...
    >
      ...
      <path d="M12 0C5.373 0 0 5.373 0 12c0 2.117.549 4.103 1.51 5.83L.057 23.428a.75.75 0 00.915.915l5.598-1.453A11.953 11.953 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.714 9.714 0 01-4.951-1.355l-.355-.211-3.676.954.974-3.562-.23-.368A9.714 9.714 0 012.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z" />
    </svg>
    +91 9303449838
  </a> */}
</p>
